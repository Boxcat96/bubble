function [loglh, probsT, At_mat, At_mat2prob, bubble] = evallp_other_variables(phi,dds,gx,hx,nstates,ETAMATRIX,YY)
...
% USE THIS FILE TO PLOT OTHER VARIABLES SUCH AS CAPACITY UTILIZATION
% JULY 2021
...
for t=1:nobs
    ...
    util(t)      = probs(1)*(-0.0508+ZZu1*At1(1,:)'/100) + probs(2)*(0.0484+ZZu2*At1(2,:)'/100) ;
    gmean(t)     = probs(1)*ghat(1,1) + probs(2)*ghat(1,2) ;
    probsT(t,:) = probs';
end
